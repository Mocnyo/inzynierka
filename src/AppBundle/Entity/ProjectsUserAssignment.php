 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ProjectsUserAssignmentRepository")
 */
class ProjectsUserAssignment
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Projects", inversedBy="userAssignment")
